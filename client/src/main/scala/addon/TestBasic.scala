...
object TestBasic extends Authentication:
  ...
  def testBasic_checkEmail(group: String, number: Int, param: String): Future[Either[Error, String]] =                      
  ...
  // http://localhost:9000/usecase/Console?param=test_--group_basic_--number_3
  def testBasic_parseJson(group: String, number: Int, param: String): Future[Either[Error, String]] = 
    import upickle.default._
  ...
  // http://localhost:9000/usecase/Console?param=test_--group_basic_--number_4_--param_TestString
  def testBasic_parseString(group: String, number: Int, param: String): Future[Either[Error, String]] = 
  ...
  // http://localhost:9000/usecase/Console?param=test_--group_basic_--number_5_--param_TestString
  def testBasic_varName(group: String, number: Int, param: String): Future[Either[Error, String]] = 
